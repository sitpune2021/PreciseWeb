                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Customer Name" id="name" name="name" value="{{ old('name', $customer->name ?? '') }}">
                                            @error('name')
                                       ...
                                       <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="tel" class="form-control" placeholder="Phone Number" id="phone_no" name="phone_no" value="{{ old('phone_no', $customer->phone_no ?? '') }}">
                                            @error('phone_no')
                                                <span class="text-red">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="GST Number" id="gst_no" name="gst_no" value="{{ old('gst_no', $customer->gst_no ?? '') }}">
                                            @error('gst_no')
                                                <span class="text-red">{{ $message }}</span>
                                                @enderror
                                            </div>
