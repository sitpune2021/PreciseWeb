                     ...
                     <form action="{{ isset($hsn) ? route('updateHsn', base64_encode($hsn->id)) : route('storeHsn') }}" method="POST">
                         ...
                         <div class="row g-3">
                             ...
                             <div class="col-md-3">
                                 ...
                                 @error('hsn_code') <small class="text-red">{{ $message }}</small> @enderror
                             </div>
                             <!-- SGST -->
                             <div class="col-md-3">
                                 ...
                                 @error('sgst') <small class="text-red">{{ $message }}</small> @enderror
                             </div>
                             <!-- CGST -->
                             <div class="col-md-3">
                                 ...
                                 @error('cgst') <small class="text-red">{{ $message }}</small> @enderror
                             </div>
                             <!-- IGST -->
                             <div class="col-md-3">
                                 ...
                                 @error('igst') <small class="text-red">{{ $message }}</small> @enderror
                             </div>
                             ...
                             <div class="col-md-6">
                                 ...
                                 @error('invoice_desc') <small class="text-red">{{ $message }}</small> @enderror
                             </div>
