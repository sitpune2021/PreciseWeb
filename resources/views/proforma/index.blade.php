            ...
            <div class="row mb-3">
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        <h4 class="mb-0 fw-bold text-primary">🧾 Proforma List</h4>
                        <div class="d-flex align-items-center gap-2">
                            <form method="GET" action="{{ route('invoice.index') }}" class="d-flex gap-2">
                                <select name="customer_id" class="form-select form-select-sm border-primary js-example-basic-single">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover align-middle text-center mb-0">
                                    <thead class="text-black" style="background-color:skyblue;">
                                        <tr>
                                            <th>#</th>
                                            <th>Invoice No</th>
                                            <th>Date</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ route('proforma.print', $invoice->id) }}" target="_blank" class="btn btn-sm btn-info rounded-pill px-3">
