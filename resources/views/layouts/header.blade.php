...
<head>
        ...
        <meta charset="utf-8" />
        <title>Precise Engineering | Dashboard</title>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarCustomers">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('AddCustomer') }}" class="nav-link" data-key="t-chat"> Add Customer </a>
                                        </li>
                                       
                                        <li class="nav-item">
                                            <a href="{{ route('ViewCustomer') }}" class="nav-link" data-key="t-chat"> View Customer </a>
                                        </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarVendor">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('AddVendor') }}" class="nav-link" data-key="t-chat"> Add Vendor </a>
                                        </li>
